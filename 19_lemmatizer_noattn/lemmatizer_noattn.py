    ...
    def construct(self, args, source_chars, target_chars, bow, eow):
        with self.session.graph.as_default():
            ...
            with tf.variable_scope('encoder'):
                ...
                rnn_cell = tf.nn.rnn_cell.GRUCell(args.rnn_dim, name="forward_GRU")
                _, source_states = tf.nn.dynamic_rnn(rnn_cell, source_embed, self.source_seq_lens, dtype=tf.float32)
            ...
            with tf.variable_scope('decoder'):
                ...
                class DecoderTraining(tf.contrib.seq2seq.Decoder):
                    ...
                    def initialize(self, name=None):
                        ...
                        inputs = tf.nn.embedding_lookup(target_embedings, tf.fill([self.batch_size], bow))# TODO: embedded BOW characters of shape [self.batch_size]. You can use
                    ...
                    def step(self, time, inputs, states, name=None):
                        ...
                        next_input = target_embed[:,time] # TODO: Next input are words with index `time` in target_embedded.
                ...
                class DecoderPrediction(tf.contrib.seq2seq.Decoder):
                    ...
                    def step(self, time, inputs, states, name=None):
                        ...
                        next_input = tf.nn.embedding_lookup(target_embedings, outputs) # TODO: Embed `outputs` using target_embeddings
