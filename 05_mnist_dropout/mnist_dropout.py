...
class Network:
    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            hidden_layer_dropout = tf.layers.dropout(hidden_layer, args.dropout, training=self.is_training, name="hidden_layer_dropout")
    ...
    def evaluate(self, dataset, images, labels):
        return self.session.run([self.accuracy, self.summaries[dataset]], {self.images: images, self.labels: labels, self.is_training: False})[0]
