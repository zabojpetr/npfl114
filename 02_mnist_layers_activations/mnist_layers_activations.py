    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            for i in range(args.layers):
                ...
                last_layer = tf.layers.dense(last_layer, args.hidden_layer, activation=activation,
...
if __name__ == "__main__":
    ...
    x = network.evaluate("test", mnist.test.images, mnist.test.labels)
    print("{:.2f}".format(x[0]*100))
