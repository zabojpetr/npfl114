    ...
    def construct(self, args):
        with self.session.graph.as_default():
            ...
            if args.hidden_layer:
                dense = tf.layers.dense(hidden_layer, args.hidden_layer, tf.nn.relu, name="Dense")
                output_layer = tf.layers.dense(dense, 1, name="OUTPUT")
            else:
            ...
            output_layer = tf.squeeze(output_layer, 2, name="Squeeze")
